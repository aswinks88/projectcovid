...
export class Charts extends Component {
  constructor(props) {
    ...
    this.deathandrecoveryRateHandler = this.deathandrecoveryRateHandler.bind(
      this
    );
    this.dhbHandler = this.dhbHandler.bind(this);
    this.totalConfirmedCaseGenderHandler = this.totalConfirmedCaseGenderHandler.bind(
      this
    );
  ...
  async totalConfirmedCaseGenderHandler() {
    await axios
      ...
      .then(async (res) => {
        ...
        const ageGroup = res.data.result.sort((a, b) => {
        ...
        this.setState({
          gender: {
            labels: [
              `Male(${this.state.genderRatio.male}%) `,
              ` Female(${this.state.genderRatio.female}%)`,
              `Others(${this.state.genderRatio.others}%)`,
            ],
            datasets: [
              {
      ...
      <div className="container-fluid">
        ...
        {!this.state.loading ? (
          <span className="text-center">
            Loading chart data...
            <Spinner
              className="spinner text-secondary"
              animation="border"
              variant="primary"
            />
          </span>
              ...
              <div className="card">
                ...
                <div className="body">
                  <ChartComponent
                    ...
                    chartType="line"
                    zoomStatus={this.state.zoomEnabledLC1}
                  />
                  {!this.state.zoomEnabledLC1 ? (
                    <button
                      className="zoombutton bg-red waves-effect"
                      onClick={() =>
                        this.zoomEnableHandlerLC1(this.state.zoomEnabledLC1)
                      }
                    >
                      Enable pan/zoom
                    </button>
              ...
              <div className="card">
                ...
                <div className="body">
                  <ChartComponent
                    ...
                    chartType="line"
                    zoomStatus={this.state.zoomEnabledLC2}
                  />
                  {!this.state.zoomEnabledLC2 ? (
                    <button
                      className="zoombutton bg-red waves-effect"
                      onClick={() =>
                        this.zoomEnableHandlerLC2(this.state.zoomEnabledLC2)
                      }
                    >
                      Enable pan/zoom
                    </button>
              ...
              <div className="card">
                ...
                <div className="body">
                  <ChartComponent
                    data={this.state.dhb}
                    chartType="hbar"
                    zoomStatus={this.state.zoomEnabledHB1}
                  />
                  {!this.state.zoomEnabledHB1 ? (
                    <button
                      className="zoombutton bg-red waves-effect"
                      onClick={() =>
                        this.zoomEnableHandlerHB1(this.state.zoomEnabledHB1)
                      }
                    >
                      Enable pan/zoom
                    </button>
              ...
              <div className="card">
                ...
                <div className="body">
                  <ChartComponent
                    ...
                    chartType="hbar"
                    zoomStatus={this.state.zoomEnabledHB2}
                  />
                  {!this.state.zoomEnabledHB2 ? (
                    <button
                      className="zoombutton bg-red waves-effect"
                      onClick={() =>
                        this.zoomEnableHandlerHB2(this.state.zoomEnabledHB2)
                      }
                    >
                      Enable pan/zoom
                    </button>
