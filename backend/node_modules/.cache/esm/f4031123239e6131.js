let axios,cheerio,fs,filesjson;_239‍.x([["getHTML",()=>getHTML],["findCovid19TotalCases",()=>findCovid19TotalCases],["casesbyDHB",()=>casesbyDHB],["findCovidDataOvertheTime",()=>findCovidDataOvertheTime],["covid19TotalCount",()=>covid19TotalCount],["TotalCasesbyDHB",()=>TotalCasesbyDHB],["covid19TotalOverTime",()=>covid19TotalOverTime]]);_239‍.w("axios",[["default",["axios"],function(v){axios=v}]]);_239‍.w("cheerio",[["default",["cheerio"],function(v){cheerio=v}]]);_239‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_239‍.w("",[["default",["filesjson"],function(v){filesjson=v}]]);
...
return summary
    ...
    const casesinDHB = []
    const readGeojson = fs.readFile('./ScrapeApi/nz.json', 'utf8', (err, data) => {
        if(err){
            _239‍.g.console.log(err)
        }
        else{
            return data
        }
    })
    _239‍.g.console.log(readGeojson)
