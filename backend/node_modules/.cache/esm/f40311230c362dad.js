let useState,axios,cheerio,fs,Path,https,url,xlsx,xlreader,xltojson;_0c3‍.x([["getHTML",()=>getHTML],["findCovid19TotalCases",()=>findCovid19TotalCases],["casesbyDHB",()=>casesbyDHB],["findCovidDataOvertheTime",()=>findCovidDataOvertheTime],["fetchRecoveryData",()=>fetchRecoveryData],["covid19TotalCount",()=>covid19TotalCount],["TotalCasesbyDHB",()=>TotalCasesbyDHB],["covid19TotalOverTime",()=>covid19TotalOverTime],["recoveryDataCount",()=>recoveryDataCount]]);_0c3‍.w("react",[["useState",["useState"],function(v){useState=v}]]);_0c3‍.w("axios",[["default",["axios"],function(v){axios=v}]]);_0c3‍.w("cheerio",[["default",["cheerio"],function(v){cheerio=v}]]);_0c3‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_0c3‍.w("path",[["default",["Path"],function(v){Path=v}]]);_0c3‍.w("https",[["default",["https"],function(v){https=v}]]);_0c3‍.w("url",[["default",["url"],function(v){url=v}]]);_0c3‍.w("xlsx",[["default",["xlsx"],function(v){xlsx=v}]]);_0c3‍.w("read-excel-file/node",[["default",["xlreader"],function(v){xlreader=v}]]);_0c3‍.w("convert-excel-to-json",[["default",["xltojson"],function(v){xltojson=v}]]);
...
const URL = {currentcases: 'https://www.health.govt.nz/our-work/diseases-and-conditions/covid-19-novel-coronavirus/covid-19-current-situation/covid-19-current-cases',
 ...
 //scraping the download link from another page but from the same site
    ...
    _0c3‍.g.console.log(result.sort())
...
// {console.log(1)}
    _0c3‍.g.console.log(filterByAge.filter(fil => {return fil.gender === 'Female' && fil.ageGroup === '20 to 29'} ).length)
    //  console.log(summary)
