let axios,cheerio,fs,Path,csvParser,fileDownload;_656‍.x([["getHTML",()=>getHTML],["findCovid19TotalCases",()=>findCovid19TotalCases],["casesbyDHB",()=>casesbyDHB],["findCovidDataOvertheTime",()=>findCovidDataOvertheTime],["fetchRecoveryData",()=>fetchRecoveryData],["covid19TotalCount",()=>covid19TotalCount],["TotalCasesbyDHB",()=>TotalCasesbyDHB],["covid19TotalOverTime",()=>covid19TotalOverTime],["recoveryDataCount",()=>recoveryDataCount]]);_656‍.w("axios",[["default",["axios"],function(v){axios=v}]]);_656‍.w("cheerio",[["default",["cheerio"],function(v){cheerio=v}]]);_656‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_656‍.w("path",[["default",["Path"],function(v){Path=v}]]);_656‍.w("csv-parser",[["default",["csvParser"],function(v){csvParser=v}]]);_656‍.w("file-download",[["default",["fileDownload"],function(v){fileDownload=v}]]);
...
const URL = {currentcases: 'https://www.health.govt.nz/our-work/diseases-and-conditions/covid-19-novel-coronavirus/covid-19-current-situation/covid-19-current-cases',
 ...
 //scraping the download link from another page but from the same site
    ...
    _656‍.g.console.log(1, url)
    fileDownload(url, path, 'cases.csv', err => {
        if(err) throw err
        console.log('success')
    })
