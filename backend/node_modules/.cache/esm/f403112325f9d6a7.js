let useState,axios,cheerio,fs,Path,https,url,xlsx,xlreader,xltojson;_25f‍.x([["getHTML",()=>getHTML],["findCovid19TotalCases",()=>findCovid19TotalCases],["casesbyDHB",()=>casesbyDHB],["findCovidDataOvertheTime",()=>findCovidDataOvertheTime],["fetchRecoveryData",()=>fetchRecoveryData],["covid19TotalCount",()=>covid19TotalCount],["TotalCasesbyDHB",()=>TotalCasesbyDHB],["covid19TotalOverTime",()=>covid19TotalOverTime],["recoveryDataCount",()=>recoveryDataCount]]);_25f‍.w("react",[["useState",["useState"],function(v){useState=v}]]);_25f‍.w("axios",[["default",["axios"],function(v){axios=v}]]);_25f‍.w("cheerio",[["default",["cheerio"],function(v){cheerio=v}]]);_25f‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_25f‍.w("path",[["default",["Path"],function(v){Path=v}]]);_25f‍.w("https",[["default",["https"],function(v){https=v}]]);_25f‍.w("url",[["default",["url"],function(v){url=v}]]);_25f‍.w("xlsx",[["default",["xlsx"],function(v){xlsx=v}]]);_25f‍.w("read-excel-file/node",[["default",["xlreader"],function(v){xlreader=v}]]);_25f‍.w("convert-excel-to-json",[["default",["xltojson"],function(v){xltojson=v}]]);
    ...
    const pathtoFiles = Path.join(__dirname, 'files')
     fs.readdir(pathtoFiles,(err, existingfile) => {
          ...
          if(filename === existingfile[0]){
            ...
            _25f‍.g.console.log(pathtoFiles + '/result.json')
          } 
          else {
            ...
            https.get(downloadUrl, res => {
                res.on('data', data => {
                    ...
                    fileWrite.end()
                    _25f‍.g.console.log(filename + ' downloaded to ' + path)
                })
            })
          }
    })
