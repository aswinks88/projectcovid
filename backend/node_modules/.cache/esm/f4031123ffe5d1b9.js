let axios,cheerio,fs,Path,papaParser;_ffe‍.x([["getHTML",()=>getHTML],["findCovid19TotalCases",()=>findCovid19TotalCases],["casesbyDHB",()=>casesbyDHB],["findCovidDataOvertheTime",()=>findCovidDataOvertheTime],["fetchRecoveryData",()=>fetchRecoveryData],["covid19TotalCount",()=>covid19TotalCount],["TotalCasesbyDHB",()=>TotalCasesbyDHB],["covid19TotalOverTime",()=>covid19TotalOverTime],["recoveryDataCount",()=>recoveryDataCount]]);_ffe‍.w("axios",[["default",["axios"],function(v){axios=v}]]);_ffe‍.w("cheerio",[["default",["cheerio"],function(v){cheerio=v}]]);_ffe‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_ffe‍.w("path",[["default",["Path"],function(v){Path=v}]]);_ffe‍.w("papaparse",[["default",["papaParser"],function(v){papaParser=v}]]);
